...
<div class="lg:sticky lg:top-0">
        <form class="space-y-4 lg:pt-8">
          <fieldset>
            <legend class="text-3xl font-bold text-[#3e311f] mb-4">Royal Hotel</legend>
            <div class="rounded border  bg-[#c5a880] p-4">
...
<div class="overflow-x-auto">
  <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
    ...
    <td class="whitespace-nowrap px-4 py-2 text-gray-700">19m<sup>2</sup></td>
      ...
      Max Guests
        ...
        <td class="whitespace-nowrap px-4 py-2 text-gray-700">7</td>
 ...
 Max Children
  ...
  <div className=' divide-y-2 divide-gray-200'>
    ...
    <p className='text-bold text-lg mt-4 text-left  '>Additional Features</p>
 <ul className='text-left list-disc list-inside '>
    ...
    <li>Air conditioning</li>
          ...
          <button
            type="submit"
            class="w-full rounded  px-6 py-3 text-sm font-bold uppercase tracking-wide text-[#3e311f] border border-[#c5a880] hover:shadow-lg hover:shadow-[#c5a880] "
          >
         Book Now
          </button>
